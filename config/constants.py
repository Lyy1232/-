...
SALES_SCENARIOS = [
    {"name": "赤城→北京公交", "base": "赤城", "dest": "北京延庆", "distance": 51, "mode": "长管拖车30MPa",
     "retail": 30, "note": "51km·出厂31元+运费3.8=到站34.8·vs零售30元·需补贴(京津冀16元)后到站18.8元✅"},
    {"name": "如东→上海化工区", "base": "如东", "dest": "上海化学工业区", "distance": 150, "mode": "液氢槽车",
     "retail": 36, "note": "150km液氢·出厂34.2元+运费2.3=到站36.5·vs零售36元·需补贴(江苏15元)后到站21.5元✅"},
    {"name": "宁东→银川物流", "base": "宁东", "dest": "银川市区", "distance": 30, "mode": "长管拖车20MPa",
     "retail": 28, "note": "30km气态·出厂27元+运费3.0=到站30.0·vs零售28元·需补贴(宁夏14元)后到站16.0元✅✅"},
    {"name": "赤城→长三角(远期)", "base": "赤城", "dest": "上海/如东", "distance": 1100, "mode": "铁路液氨→裂解",
     "retail": 36, "note": "铁路1100km·出厂31元+运费0.3=到站31.3·vs零售36元✅·唯一不需补贴的场景"},
    {"name": "鄂尔多斯→北京(规划)", "base": "鄂尔多斯", "dest": "北京", "distance": 500, "mode": "液氢槽车",
     "retail": 30, "note": "500km液氢·出厂11.2元+运费7.5=到站18.7·vs零售30元·鄂尔多斯低电价优势✅"},
    {"name": "实验室/半导体用氢(小批量)", "base": "赤城", "dest": "北京实验室集群", "distance": 80, "mode": "长管拖车20MPa",
     "retail": 50, "note": "80km气态·出厂31元+运费8.0=到站39.0·vs零售50元·高纯溢价场景✅✅"},
]
...
# ── 城市群补贴标准（元/kg）──
# 来源：氢能综合应用试点（工信部联节〔2026〕59号）"以奖代补"· 第二批示范城市群
# 中央财政奖励：1积分=8万元，地方按≥1:1配套 → 合计补贴换算约15-18元/kg
CITY_SUBSIDIES = {
    "广东(佛山)": 18.0,
    "京津冀": 16.0,
    "河北": 16.0,
